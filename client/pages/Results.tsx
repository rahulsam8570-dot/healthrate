...
export default function Results() {
    ...
    const fetchClinics = async () => {
      try {
        const response = await fetch(
          `/api/clinics/search?procedure=${encodeURIComponent(procedure)}&price=${userPrice}`,
        );
  ...
  const averagePrice =
    clinics.reduce((sum, clinic) => sum + clinic.price, 0) / clinics.length;
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
                  ...
                  <div>
                    ...
                    {savings > 0 ? (
                      ...
                      <div className="flex items-center gap-1 text-red-600">
                        ...
                        <span className="text-sm">
                          You overpaid by ${Math.abs(savings).toFixed(2)}
                        </span>
                      </div>
                    )}
                  </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Select
              value={sortBy}
              onValueChange={(value: "price" | "rating" | "distance") =>
                setSortBy(value)
              }
            >
        ...
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>
              Interactive map showing clinic locations near you
            </CardDescription>
          </CardHeader>
          <CardContent>
