...
const mockClinics: Clinic[] = [
  {
    ...
    lat: 40.7128,
    lng: -74.0060,
    availableTests: ['Blood Test - Complete Blood Count (CBC)', 'Lipid Panel', 'X-Ray - Chest', 'Ultrasound - Abdominal']
  },
  {
    id: '2',
    ...
    lat: 40.7589,
    lng: -73.9851,
    availableTests: ['Blood Test - Complete Blood Count (CBC)', 'Thyroid Function Test', 'Blood Test - Glucose', 'Urinalysis']
  },
  {
    id: '3',
    ...
    lat: 40.7831,
    lng: -73.9712,
    availableTests: ['MRI - Brain', 'X-Ray - Chest', 'Ultrasound - Abdominal', 'Radiologist Reading']
  },
  {
    id: '4',
    ...
    lat: 40.6892,
    lng: -74.0445,
    availableTests: ['Blood Test - Complete Blood Count (CBC)', 'Lipid Panel', 'Thyroid Function Test', 'Blood Test - Glucose']
  },
  {
    id: '5',
    ...
    lat: 40.7282,
    lng: -73.9942,
    availableTests: ['MRI - Brain', 'X-Ray - Chest', 'Ultrasound - Abdominal', 'Radiologist Reading', 'Lipid Panel']
  },
  {
    id: '6',
    ...
    lat: 40.6782,
    lng: -74.0201,
    availableTests: ['Blood Test - Complete Blood Count (CBC)', 'Blood Test - Glucose', 'Urinalysis', 'Thyroid Function Test']
  },
  {
    id: '7',
...
export const searchClinics: RequestHandler = async (req, res) => {
  try {
    ...
    let availableClinics = mockClinics.filter(clinic => 
      clinic.availableTests.some(test => 
